...
echo "ii=${ii} m1=${m1} x1=${x1} m2=${m2} x2=${x2} mass1=95.95 mass2=183.84 mass3=${mass3} align=${align} partition=${partition}"
...
#read_restart ${newDir}/restart/ii${ii}.*.restart

### interactions
pair_style mace
pair_coeff * * /home/theory/phrrpq/bilayer_relaxations/MoWSSe_bi_radius_8_reduced_all_1_swa_800_run-123_swa.model-lammps.pt ${m1} ${x1} ${m2}
mass 1 95.95
mass 2 183.84
mass 3 ${mass3}
...
thermo_style custom step time temp cpu etotal fmax fnorm
